...
import { IOrder, IOrderItem, QUERY_ORDERS } from '../../data';
    ...
    return (
        <>
            ...
            <List spacing={5}>
                {
                    orders.map(item => (
                        <ListItem key={item.id} boxShadow='outline' p={5} rounded='lg'
                            _hover={{
                                background: "white",
                                color: "teal.500",
                                cursor: "pointer"
                            ...
                            <VStack spacing={2}>
                                <Flex direction={'row'} w={'100%'}>
                                    <Stack direction={'row'} spacing={'50px'}>
                                        ...
                                        <Box><OrderStateBadge state={item.state} fontSize={'0.8em'}></OrderStateBadge></Box>
                                        <Box>
